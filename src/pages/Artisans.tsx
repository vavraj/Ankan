          ...
          <div className="flex flex-wrap justify-center gap-8 mb-16">
            {artisans.map((artisan, index) => (
              <div key={index} className="w-40 flex flex-col items-center">
                <div className="w-40 h-40 rounded-full overflow-hidden bg-gray-300"></div>
            ...
            {artisans.map((artisan, index) => (
              <div key={index} className="mb-16">
                <div className={`flex flex-col md:flex-row ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                  <div className="w-full md:w-1/2 bg-gray-200 h-64 md:h-auto"></div>
      ...
      <div className="bg-gray-800 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-8">
            <Link href="#" className="w-12 h-12 bg-black rounded-full flex items-center justify-center">
              <Facebook size={24} />
            </Link>
            <Link href="#" className="w-12 h-12 bg-black rounded-full flex items-center justify-center">
              <Instagram size={24} />
